...
int i, n, cont;
char c;
int vect[1000000000000000000000000000000000000000];

void main () {
  i=0;
  do {
    printf ("Dame el valor que quieras agregar a la matriz: \n");
    scanf ("%d", &n);
    vect[i]=n;
    ++i;
  ...
  for (cont=0; cont<=i; cont++)
    n=n+vect[cont];
  printf ("La suma de los valores de la matriz es de: %d \n", n);
}
